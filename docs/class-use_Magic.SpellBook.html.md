Uses of Class simple.hooks.simplebot.Magic.SpellBook   <!-- try { if (location.href.indexOf('is-external=true') == -1) { parent.document.title="Uses of Class simple.hooks.simplebot.Magic.SpellBook"; } } catch(err) { } //-->
