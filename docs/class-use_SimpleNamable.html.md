Uses of Interface simple.hooks.interfaces.SimpleNamable   <!-- try { if (location.href.indexOf('is-external=true') == -1) { parent.document.title="Uses of Interface simple.hooks.interfaces.SimpleNamable"; } } catch(err) { } //-->
