Uses of Class simple.hooks.wrappers.SimpleLocalPlayer   <!-- try { if (location.href.indexOf('is-external=true') == -1) { parent.document.title="Uses of Class simple.hooks.wrappers.SimpleLocalPlayer"; } } catch(err) { } //-->
