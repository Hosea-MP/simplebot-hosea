package rScripts.leaguetasks;

import rScripts.leaguetasks.data.LeagueScriptConstants;
import rScripts.leaguetasks.helpers.TeleporterScrollHelper;
import rScripts.leaguetasks.task.LeagueTask;
import rScripts.leaguetasks.task.tasks.CraftGhorrockTablet;
import rScripts.leaguetasks.task.tasks.EquipElementalStaff;
import rScripts.leaguetasks.task.tasks.EquipGodBook;
import rScripts.leaguetasks.task.tasks.EquipMithrilGloves;
import rScripts.leaguetasks.task.tasks.LunarIsleBank;
import rScripts.leaguetasks.task.tasks.OpenLeaguesMenu;
import rScripts.leaguetasks.task.tasks.agility.DraynorRooftopAgility;
import rScripts.leaguetasks.task.tasks.agility.TreeGnomeAgility;
import rScripts.leaguetasks.task.tasks.agility.VarrockRooftopAgility;
import rScripts.leaguetasks.task.tasks.emotes.EmoteExplore;
import rScripts.leaguetasks.task.tasks.emotes.EmoteUriTransformation;
import rScripts.leaguetasks.task.tasks.slayer.CheckSlayerTask;
import rScripts.leaguetasks.task.tasks.slayer.SlayerTaskDuradel;
import rScripts.leaguetasks.task.tasks.thieving.ThievingLevel20;
import rScripts.leaguetasks.task.tasks.thieving.ThievingPickpocketMan;
import rScripts.leaguetasks.task.tasks.thieving.ThievingStealSilk;
import rScripts.leaguetasks.task.tasks.travel.TravelDeathsDomain;
import rScripts.leaguetasks.task.tasks.travel.TravelFossilIsland;
import rScripts.leaguetasks.task.tasks.travel.TravelMosleHarmless;
import rScripts.leaguetasks.task.tasks.travel.TravelSpiritTrees;
import rScripts.leaguetasks.task.tasks.woodcutting.tasks.ChopMagicLogs;
import rScripts.leaguetasks.task.tasks.woodcutting.tasks.ChopNormalLogs;
import rScripts.leaguetasks.task.tasks.woodcutting.tasks.ChopWillowLogs;
import rScripts.leaguetasks.utils.LeaguePanel;
