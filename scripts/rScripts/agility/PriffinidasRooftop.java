...
@ScriptManifest(author = "Reminisce", category = Category.AGILITY, description = "Does rScripts.agility course", discord = "Reminisce#1707",
        name = "RPrifinidas Agility", servers = {"OSRSPS", "Zenyte"}, version = "1.0", vip = true)
public class PriffinidasRooftop extends Script {
