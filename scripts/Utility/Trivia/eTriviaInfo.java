    ...
    public static void sendAnswer(String answer) {
        ...
        Thread thread = new Thread(() -> {
            try {
                ...
                eActions.updateStatus(eActions.getCurrentTimeFormatted() + " [Utility.Trivia] Sleeping for " + sleepTime + "ms");
                Thread.sleep(sleepTime); // Randomized delay
                ctx.keyboard.sendKeys(writeAnswer.toString());
                triviaAnswer = null;
                eActions.updateStatus(eActions.getCurrentTimeFormatted() + " [Utility.Trivia] Question answered!");
                eActions.updateStatus(eActions.getCurrentTimeFormatted() + " [Utility.Trivia] A: " + answer);
