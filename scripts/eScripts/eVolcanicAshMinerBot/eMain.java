package eScripts.eVolcanicAshMinerBot;
...
public class eMain extends TaskScript implements LoopingScript {
    ...
    public void onProcess() {
        ...
        int currentCount = eScripts.BotUtils.eActions.getNotedItemCount(ItemID.VOLCANIC_ASH);
    ...
    private void miningTask() {
        ...
        if (volcanicAshMine == null) {
            eScripts.BotUtils.eActions.status = "Waiting...";
            return;
        }
        eScripts.BotUtils.eActions.status = "Mining...";
        eScripts.BotUtils.eActions.interactWith(volcanicAshMine, "Mine");
                ...
                for (WorldPoint ashTile : ashLocations) {
                    if (ashTile != null) {
                        if (ashMineObjectAppeared(ashTile)) {
                            eScripts.BotUtils.eActions.drawTileMatrix(ctx, (Graphics2D) g, ashTile, Color.GREEN);
                        } else {
                            eScripts.BotUtils.eActions.drawTileMatrix(ctx, (Graphics2D) g, ashTile, Color.YELLOW);
                        }
                    }
                }
            }
