...
@ScriptManifest(
        ...
        description = "<html>"
                + "<p>The most effective rScripts.agility bot on Zenyte!</p>"
                + "<p><strong>Features & recommendations:</strong></p>"
                + "<ul>"
                + "<li>Always start the bot <b>at the beginning of rScripts.agility course!</b>.</li>"
...
public class eMain extends TaskScript implements LoopingScript {
    ...
    public void onExecute() {
        ...
        tasks.addAll(Arrays.asList(new eScripts.eApiAccess.eAutoResponser(ctx)));// Adds tasks to our {task} list for execution

        // Setting up GPT Gui
        eAutoResponser.scriptPurpose = "you're grinding to get rScripts.agility pet.";
