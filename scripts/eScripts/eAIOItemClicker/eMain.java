...
import static eScripts.eApiAccess.eAutoResponser.botStarted;
import static eScripts.eApiAccess.eAutoResponser.gptDeactivation;
...
public class eMain extends TaskScript implements LoopingScript {
    ...
    private void useItemOnItem() {
        ...
        eScripts.BotUtils.eActions.updateStatus("Using " + itemInv.getName().toLowerCase() + " on " + toolInv.getName().toLowerCase());
        toolInv.click("Use");
        ctx.sleep(50, 100);
        itemInv.click(0);
        ...
        if (widgetVisible()) {
            ...
            eScripts.BotUtils.eActions.updateStatus("Cutting " + itemInv.getName().toLowerCase());
        }
    }
