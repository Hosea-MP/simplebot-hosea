...
public class ChatMessage {
    ...
    public String toString() {
        return "ChatMessage(messageNode=" + this.getMessageNode() + ", type=" + this.getType() + ", name=" + this.getName() + ", message=" + this.getMessage() + ", sender=" + this.getSender() + ", timestamp=" + this.getTimestamp() + ")";
    }
