...
public class AreaSoundEffectPlayed {
    ...
    public boolean equals(Object o) {
        ...
        if (this.getLoops() != other.getLoops()) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = result * 59 + this.getLoops();
    ...
    public String toString() {
        return "AreaSoundEffectPlayed(source=" + this.getSource() + ", soundId=" + this.getSoundId() + ", sceneX=" + this.getSceneX() + ", sceneY=" + this.getSceneY() + ", range=" + this.getRange() + ", delay=" + this.getDelay() + ", loops=" + this.getLoops() + ", consumed=" + this.isConsumed() + ")";
    }
}
