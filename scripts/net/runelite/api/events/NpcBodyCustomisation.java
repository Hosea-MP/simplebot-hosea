...
public class NpcBodyCustomisation {
    private final NPC npc;
    private final NpcTypeCustomisation npcTypeCustomisation;

    public NpcBodyCustomisation(NPC npc, NpcTypeCustomisation npcTypeCustomisation) {
        this.npc = npc;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NpcBodyCustomisation)) {
            return false;
        }
        NpcBodyCustomisation other = (NpcBodyCustomisation)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof NpcBodyCustomisation;
    }
    ...
    public String toString() {
        return "NpcBodyCustomisation(npc=" + this.getNpc() + ", npcTypeCustomisation=" + this.getNpcTypeCustomisation() + ")";
    }
}
