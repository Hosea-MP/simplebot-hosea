...
public class MenuOptionClicked {
    ...
    public String toString() {
        return "MenuOptionClicked(getParam0=" + this.getParam0() + ", getParam1=" + this.getParam1() + ", getMenuOption=" + this.getMenuOption() + ", getMenuTarget=" + this.getMenuTarget() + ", getMenuAction=" + this.getMenuAction() + ", getId=" + this.getId() + ")";
    }
