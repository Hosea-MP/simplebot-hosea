...
GameEngine {
    ...
    public NetWriter getPacketWriter();

    public int getLatestWidgetCall();

    public void setLatestWidgetCall(int var1);
    ...
    public boolean[] cameraShaking();

    public int[] cameraShakeIntensity();

    public int[] cameraMoveIntensity();

    public int[] cameraShakeSpeed();

    public int[] cameraShakeCycle();

    public int cameraLookAtX();

    public int cameraLookAtY();

    public int cameraLookAtHeight();

    public int cameraLookAtSpeed();

    public int cameraLookAtAcceleration();

    public int cameraMoveToX();

    public int cameraMoveToY();

    public int cameraMoveToHeight();

    public int cameraMoveToSpeed();

    public int cameraMoveToAcceleration();

    public int getMinimapState();

    public long getUserRegistrationId();

    public void setRSMouseIdleTicks(int var1);
}
