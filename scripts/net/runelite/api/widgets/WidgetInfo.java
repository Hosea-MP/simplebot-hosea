...
public enum WidgetInfo {
    ...
    MUSIC_WINDOW(239, 0),
    MUSIC_TRACK_LIST(239, 6),
    MUSIC_TRACK_SCROLL_CONTAINER(239, 4),
    MUSIC_TRACK_SCROLLBAR(239, 7),
    ...
    BANK_EQUIPMENT_BUTTON(12, 114),
    BANK_JAGEX_ACCOUNT_AD(12, 116),
    ...
    LOGIN_CLICK_TO_PLAY_SCREEN_MESSAGE_OF_THE_DAY(378, 6),
    ...
    CHARACTER_SUMMARY_CONTAINER(712, 2),
    QUESTLIST_BOX(399, 0),
    QUESTLIST_CONTAINER(399, 2),
    SEED_VAULT_TITLE_CONTAINER(631, 2),
    SEED_VAULT_ITEM_CONTAINER(631, 15),
    SEED_VAULT_ITEM_TEXT(631, 16),
    SEED_VAULT_SEARCH_BUTTON(631, 24),
    SEED_VAULT_INVENTORY_ITEMS_CONTAINER(630, 1),
    SETTINGS_SIDE_CAMERA_ZOOM_SLIDER_TRACK(116, 57),
    SETTINGS_SIDE_MUSIC_SLIDER(116, 92),
    SETTINGS_SIDE_MUSIC_SLIDER_STEP_HOLDER(116, 104),
    SETTINGS_SIDE_SOUND_EFFECT_SLIDER(116, 106),
    SETTINGS_SIDE_AREA_SOUND_SLIDER(116, 120),
    SETTINGS_INIT(134, 1),
    ...
    public static int TO_GROUP(int id2) {
        return id2 >>> 16;
    }

    public static int TO_CHILD(int id2) {
        return id2 & 0xFFFF;
    }
